      ...
      links: [
        {
          ...
          items: [
            ...
            {label: 'Course Overview', to: '/docs/course-overview'},
        ...
        },
        {
          title: 'Modules',
          items: [
            {label: 'Module 1: Foundations', to: '/docs/physical-ai-foundations'},
            {label: 'Module 2: ROS 2', to: '/docs/ros2-intro'},
            {label: 'Module 4: NVIDIA Isaac', to: '/docs/isaac-sim-synthetic-data'},
            {label: 'Module 5: VLA & AI', to: '/docs/vla-overview'},
          ],
        },
        {
          title: 'Reference',
